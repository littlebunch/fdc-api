...
######################################################
curl -u Administrator:password -X POST http://localhost:8091/pools/default/buckets -d name=gnutdata -d ramQuotaMB=100 -d bucketType=couchbase -d authType=none
